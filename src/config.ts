...
export default {
    ...
    defaultVolume: process.env.DEFAULT_VOLUME ? parseInt(process.env.DEFAULT_VOLUME) : 100,
    links: {
        img: process.env.IMG_LINK || 'https://i.imgur.com/ud3EWNh.jpg',
    }, // image links
    icons: {
        youtube: 'https://i.imgur.com/T7G2Q0C.png',
        spotify: 'https://i.imgur.com/D0jUZXd.png',
